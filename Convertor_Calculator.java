public class UnitConverter {
    ...
    public static double convertKmToMiles(double km) {
        double kmToMiles = 0.621371; // Local variable for conversion factor
        return km * kmToMiles;
    }

    // Method to convert miles to kilometers
    public static double convertMilesToKm(double miles) {
        double milesToKm = 1.60934; // Local variable for conversion factor
        return miles * milesToKm;
    }

    // Method to convert meters to feet
    public static double convertMetersToFeet(double meters) {
        double metersToFeet = 3.28084; // Local variable for conversion factor
        return meters * metersToFeet;
    }

    // Method to convert feet to meters
    public static double convertFeetToMeters(double feet) {
        double feetToMeters = 0.3048; // Local variable for conversion factor
